...
function create_block_beta_digital_blocks_block_init() {
	register_block_type( __DIR__ . '/build/block-two-column-image' );
	register_block_type( __DIR__ . '/build/block-three-column-image' );
	register_block_type( __DIR__ . '/build/block-intro' );
	register_block_type( __DIR__ . '/build/block-wide-image' );
}
